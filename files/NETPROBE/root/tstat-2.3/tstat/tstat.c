  ...
  if (log_engine)
    {
      ...
      reopen_logfile(&fp_dup_ooo_log,basename,"dup_ooo");
      /* MGM stop */
#endif
    }
...
#ifdef LOG_OOO
      if (fp_dup_ooo_log != NULL) { gzclose(fp_dup_ooo_log); fp_dup_ooo_log=NULL; }
#endif
    }
  else
#endif   /* HAVE_ZLIB */
...
#ifdef LOG_OOO
      if (fp_dup_ooo_log != NULL) { fclose(fp_dup_ooo_log); fp_dup_ooo_log=NULL; }
#endif
    }
}
