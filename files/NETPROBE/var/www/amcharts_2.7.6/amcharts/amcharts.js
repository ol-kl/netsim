var AmCharts = {inheriting:{}, Class:function (objSet) {
    var b = function () {
        arguments[0] !== AmCharts.inheriting && (this.events = {}, this.construct.apply(this, arguments))
    };
    objSet.inherits ? (b.prototype = new objSet.inherits(AmCharts.inheriting), b.base = objSet.inherits.prototype, delete objSet.inherits) : (b.prototype.createEvents = function () {
    ...
    for (var d in objSet)b.prototype[d] = objSet[d];
    return b
},
...
AmCharts.AmChart = AmCharts.Class({construct:function () {
    ...
    var a =
        this.container, b = this.realWidth, d = this.realHeight, e = this.set, f = AmCharts.polygon(a, [0, b - 1, b - 1, 0], [0, 0, d - 1, d - 1], this.backgroundColor, this.backgroundAlpha, 1, this.borderColor, this.borderAlpha);
    this.background = f;
    e.push(f);
    ...
    var g = AmCharts.removePx(AmCharts.getStyle(a, "padding-left")), h = AmCharts.removePx(AmCharts.getStyle(a,
        "padding-right")), i = AmCharts.removePx(AmCharts.getStyle(a, "padding-top")), j = AmCharts.removePx(AmCharts.getStyle(a, "padding-bottom"));
    isNaN(g) || (d -= g);
    isNaN(h) || (d -= h);
    isNaN(i) || (e -= i);
    isNaN(j) || (e -= j);
    ...
    if (a != this.previousWidth || g != this.previousHeight)b.style.width = a + "px", b.style.height = g + "px", f && f.setSize(a,
    ...
    if (d) {
        var e = this.legendDiv, f = e.offsetWidth, g =
            e.offsetHeight, e = e.style, h = this.chartDiv.style, d = d.position;
    ...
    validateSize:function () {
        ...
        a.measure();
        var b = a.legend;
        if ((a.realWidth != a.previousWidth || a.realHeight != a.previousHeight) && 0 < a.realWidth && 0 < a.realHeight && a.chartCreated) {
            a.sizeChanged = !0;
            if (b) {
...
AmCharts.formatNumber = function (a, b, d, e, f) {
    ...
    var g = b.decimalSeparator, b = b.thousandsSeparator, h = 0 > a ? "-" : "", a = Math.abs(a), i = a.toString(), j = !1;
    -1 != i.indexOf("e") && (j = !0);
...
AmCharts.findIfFixed = function (a) {
    if (a.offsetParent)for (; a = a.offsetParent;)if ("fixed" == a.style.position)return!0;
    return!1
};
...
AmCharts.Bezier = AmCharts.Class({construct:function (a, b, d, e, f, g, h, i, j, k) {
    ...
    f = [];
    for (j = 0; j < b.length; j++)f.push({x:Number(b[j]), y:Number(d[j])});
...
AmCharts.Cuboid = AmCharts.Class({construct:function (a, b, d, e, f, g, h, i, j, k, l, m, q) {
    ...
    var b = this.container, d = this.w, e = this.h, f = this.dx, g = this.dy, h = this.colors, i = this.alpha, j = this.bwidth,
        k = this.bcolor, l = this.balpha, m = this.gradientRotation, q = this.cornerRadius, n = h, p = h;
    "object" == typeof h && (n = h[0], p = h[h.length - 1]);
    if (0 < f || 0 < g) {
        var o = p, p = AmCharts.adjustLuminosity(n, -0.2), p = AmCharts.adjustLuminosity(n, -0.2), r = AmCharts.polygon(b, [0, f, d + f, d, 0], [0, g, g, 0, 0], p, i, 0, 0, 0, m);
        if (0 < l)var s = AmCharts.line(b, [0, f, d + f], [0, g, g], k, l, j);
        var t = AmCharts.polygon(b, [0, 0, d, d, 0], [0, e, e, 0, 0], p, i, 0, 0, 0, 0, m);
        t.translate(f, g);
        if (0 < l)var w = AmCharts.line(b, [f, f], [g, g + e], k, 1, j);
        var y = AmCharts.polygon(b, [0, 0, f, f, 0], [0,
            e, e + g, g, 0], p, i, 0, 0, 0, m), x = AmCharts.polygon(b, [d, d, d + f, d + f, d], [0, e, e + g, g, 0], p, i, 0, 0, 0, m);
        if (0 < l)var u = AmCharts.line(b, [d, d + f, d + f, d], [0, g, e + g, e], k, l, j);
        p = AmCharts.adjustLuminosity(o, 0.2);
        o = AmCharts.polygon(b, [0, f, d + f, d, 0], [e, e + g, e + g, e, e], p, i, 0, 0, 0, m);
        if (0 < l)var B = AmCharts.line(b, [0, f, d + f], [e, e + g, e + g], k, l, j)
    }
    1 > Math.abs(e) && (e = 0);
    1 > Math.abs(d) && (d = 0);
    b = 0 == e ? AmCharts.line(b, [0, d], [0, 0], n, l, j) : 0 == d ? AmCharts.line(b, [0, 0], [0, e], n, l, j) : 0 < q ? AmCharts.rect(b, d, e, h, i, j, k, l, q, m) : AmCharts.polygon(b, [0, 0, d, d, 0],
        [0, e, e, 0, 0], h, i, j, k, l, m);
    e = 0 > e ? [r, s, t, w, y, x, u, o, B, b] : [o, B, t, w, y, x, r, s, u, b];
    for (r = 0; r < e.length; r++)(s = e[r]) && a.push(s)
}, width:function (a) {
    this.w = a;
    this.draw()
}, height:function (a) {
...
AmCharts.AmLegend = AmCharts.Class({construct:function () {
    ...
    var a = this.position, b = this.marginLeft + this.titleWidth, d = this.marginRight, e = this.marginTop, f = this.marginBottom, g = this.horizontalGap, h = this.div, i = this.divWidth, j = this.maxColumns,
        k = this.verticalGap, l = this.spacing, m = i - d - b, q = 0, n = 0, p = this.container, o = p.set();
    this.set = o;
    p = p.set();
    o.push(p);
    ...
    for (var y = w = 0, x = g, s = 0; s < r.length; s++) {
        var u = r[s];
        this.reversedOrder && (u = r[r.length - s - 1]);
        var t = u.getBBox(), B;
        this.equalWidths ? B = g + y * (q + l + this.markerLabelGap) : (B = x, x = x + t.width + g + l);
        B + t.width > m && 0 < s && (w++, y = 0, B = g, x = B + t.width + g + l);
        u.translate(B, (n + k) * w);
        y++;
        !isNaN(j) && y >= j && (y = 0, w++);
        p.push(u)
    ...
    d.toBack();
    b = g;
    if ("top" == a || "bottom" == a || "absolute" == a)"center" == this.align ? b = g + (i - t.width) / 2 : "right" == this.align && (b = g + i - t.width);
    p.translate(b, k + 1);
    ...
    rollOutMarker:function (a) {
        ...
        var a = this.markerSize - 3, b = {stroke:this.switchColor, "stroke-width":3}, d = this.container, e = AmCharts.line(d, [3, a], [3, a]).attr(b), a = AmCharts.line(d, [3, a], [a, 3]).attr(b);
...
AmCharts.AmBalloon = AmCharts.Class({construct:function () {
    ...
    if (!isNaN(a)) {
        ...
        if (this.show) {
            ...
            var p = this.horizontalPadding, o = this.verticalPadding, m = this.pointerWidth, r = this.pointerOrientation, s = this.cornerRadius,
                t = e.fontFamily, w = this.fontSize;
            void 0 == w && (w = e.fontSize);
            e = AmCharts.text(f, this.text, this.color, t, w, d);
            g.push(e);
            if (void 0 != l) {
                var y = AmCharts.text(f, this.text, l, t, w, d, !1, 0.4);
                g.push(y)
            }
            t = e.getBBox();
            l = t.height + 2 * o;
            ...
            "H" != r ? (x = a - o / 2, d = b < i + l + 10 && "down" != r ? b + m : b - l - m) : (2 * m > l && (m = l / 2), d = b - l / 2, x = a < h + (j - h) / 2 ? a + m : a - o - m);
            d + l >= k && (d = k - l);
            d < i && (d =
                i);
            x < h && (x = h);
            x + o > j && (x = j - o);
            0 < s || 0 == m ? (n = AmCharts.rect(f, o, l, q, this.fillAlpha, this.borderThickness, n, this.borderAlpha, this.cornerRadius), this.showBullet && (f = AmCharts.circle(f, this.bulletSize, q, this.fillAlpha), f.translate(a, b), this.pointer = f)) : (k = [], s = [], "H" != r ? (h = a - x, h > o - m && (h = o - m), h < m && (h = m), k = [0, h - m, a - x, h + m, o, o, 0, 0], s = b < i + l + 10 && "down" != r ? [0, 0, b - d, 0, 0, l, l, 0] : [l, l, b - d, l, l, 0, 0, l]) : (i = b - d, i > l - m && (i = l - m), i < m && (i = m), s = [0, i - m, b - d, i + m, l, l, 0, 0], k = a < h + (j - h) / 2 ? [0, 0, a - x, 0, 0, o, o, 0] : [o, o, a - x, o, o, 0, 0, o]), n = AmCharts.polygon(f,
...
AmCharts.AmCoordinateChart = AmCharts.Class({inherits:AmCharts.AmChart, construct:function () {
    ...
    if (e) {
        ...
        for (var j = 0; j < e.length; j++) {
            ...
            k.category = String(m);
            i[l[d]] = k;
            f && (m = new Date(m.getFullYear(), m.getMonth(), m.getDate(), m.getHours(), m.getMinutes(), m.getSeconds(), m.getMilliseconds()),
                m = AmCharts.resetDateToMin(m, h, g), k.category = m, k.time = m.getTime());
    ...
    for (b = 0; b < a.length; b++)m =
        a[b], m.dataProvider && this.parseGraphData(m)
    ...
    for (var e = 0; e < b.length; e++) {
        var f = b[e], g = this.lookupTable[String(f[d])],
            h = a.valueAxis.id;
...
AmCharts.TrendLine = AmCharts.Class({construct:function () {
    ...
    var a = this;
    a.destroy();
    var b = a.chart, d = b.container, e, f, g, h, i = a.categoryAxis, j = a.initialDate, k = a.initialCategory, l = a.finalDate, m = a.finalCategory, q = a.valueAxis, n = a.valueAxisX, p = a.initialXValue, o = a.finalXValue, r = a.initialValue, s = a.finalValue, t = q.recalculateToPercents;
    i && (j && (e = i.dateToCoordinate(j)), k && (e =
        i.categoryToCoordinate(k)), l && (f = i.dateToCoordinate(l)), m && (f = i.categoryToCoordinate(m)));
    n && !t && (isNaN(p) || (e = n.getCoordinate(p)), isNaN(o) || (f = n.getCoordinate(o)));
...
AmCharts.AmSerialChart = AmCharts.Class({inherits:AmCharts.AmRectangularChart, construct:function () {
    ...
    if (!isNaN(d) && (b != this.endTime && b - a > d && (a = b - d, this.updateScrollbar = !0), a != this.startTime && b - a > d))b = a + d, this.updateScrollbar =
        !0;
    ...
    updateColumnsDepth:function () {
        ...
        for (var a = 0, b = this.valueAxes.length, d = this.graphs.length, e, f, g = !1, h, i = 0; i < b; i++) {
            ...
            if ("none" ==
                j || "3d" == j)for (h = 0; h < d; h++)e = this.graphs[h], !e.hidden && (e.valueAxis == f && "column" == e.type) && (e.columnIndex = a, a++);
            if ("3d" == j) {
...
AmCharts.ValueAxis = AmCharts.Class({inherits:AmCharts.AxisBase, construct:function () {
    ...
    this.synchronizationMultiplyer && this.synchronizeWithAxis ?
    ...
    if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum))this.fire("logarithmicAxisFailed", {type:"logarithmicAxisFailed", chart:a}); else {
        ...
        if (!isNaN(this.min) &&
            ...
            var k = this.labelFrequency, l = this.showFirstLabel, m = this.showLastLabel, q = 1, n = 0, p = Math.round((this.max - this.min) / this.step) + 1;
            if (!0 == i) {
                var o = Math.log(this.max) * Math.LOG10E - Math.log(this.minReal) * Math.LOG10E;
                this.stepWidth = this.axisWidth / o;
                2 < o && (p = Math.ceil(Math.log(this.max) * Math.LOG10E) + 1, n = Math.round(Math.log(this.minReal) * Math.LOG10E), p > this.gridCount && (q = Math.ceil(p / this.gridCount)))
            ...
            if (0 < t) {
                ...
                for (e = this.fillAlpha = 0; e < t; e++) {
                    var y = s[e], x = NaN;
                    if (!isNaN(y.toValue)) {
                        var x = this.getCoordinate(y.toValue), u = new this.axisItemRenderer(this, x, "", !0, NaN, NaN, y);
                        this.pushAxisItem(u)
                    }
                    var B = NaN;
                    isNaN(y.value) || (B = this.getCoordinate(y.value), u = new this.axisItemRenderer(this, B, y.label, !0, NaN, (x - B) / 2, y), this.pushAxisItem(u));
                    isNaN(x - B) || (u = new this.guideFillRenderer(this, B, x, y), this.pushAxisItem(u), u = u.graphics(), y.graphics = u, y.balloonText && this.addEventListeners(u, y))
                }
                this.fillAlpha = w
            }
            s = !1;
            for (e = n; e < p; e +=
                q)u = AmCharts.roundTo(this.step * e + this.min, d), -1 != String(u).indexOf("e") && (s = !0, String(u).split("e"));
            this.duration && (this.maxInterval = AmCharts.getMaxInterval(this.max, this.duration));
            for (e = n; e < p; e += q)if (n = this.step * e + this.min, n = AmCharts.roundTo(n, this.maxDecCount + 1), !(this.integersOnly && Math.round(n) != n)) {
                !0 == i && (0 == n && (n = this.minReal), 2 < o && (n = Math.pow(10, e)), s = -1 != String(n).indexOf("e") ? !0 : !1);
                this.useScientificNotation && (s = !0);
                this.usePrefixes && (s = !1);
                s ? (u = -1 == String(n).indexOf("e") ? n.toExponential(15) :
                    String(n), u = u.split("e"), d = Number(u[0]), u = Number(u[1]), d = AmCharts.roundTo(d, 14), 10 == d && (d = 1, u += 1), u = d + "e" + u, 0 == n && (u = "0"), 1 == n && (u = "1")) : (i && (d = String(n).split("."), r.precision = d[1] ? d[1].length : -1), u = this.usePrefixes ? AmCharts.addPrefix(n, a.prefixesOfBigNumbers, a.prefixesOfSmallNumbers, r) : AmCharts.formatNumber(n, r, r.precision));
                this.duration && (u = AmCharts.formatDuration(n, this.duration, "", this.durationUnits, this.maxInterval, r));
                this.recalculateToPercents ? u += "%" : (d = this.unit) && (u = "left" == this.unitPosition ?
                    d + u : u + d);
                ...
                if (n == this.baseValue && "radar" != j) {
                    ...
                    I && (d = AmCharts.fitToBounds(2 * this.gridAlpha, 0, 1), d = AmCharts.line(a.container, I, D, this.gridColor, d, 1, this.dashLength), d.translate(n, u), this.grid0 = d, a.axesSet.push(d),
                        d.toBack())
                }
            }
            e = this.baseValue;
    ...
    if (("line" == a || "step" == a || "smoothedLine" ==
        a) && ("regular" == b || "100%" == b))for (l = 0; l < i.length; l++)h = i[l], h.hidden || (k = h.type, h.chart == this.chart && (h.valueAxis == this && a == k && h.stackable) && (j && (h.stackGraph = j), j = h));
    for (j = this.start; j <= this.end; j++) {
        var q = 0;
        for (l = 0; l < i.length; l++)if (h = i[l], !h.hidden && (k = h.type, h.chart == this.chart && (h.valueAxis == this && a == k && h.stackable) && (k = this.data[j].axes[this.id].graphs[h.id], h = k.values.value, !isNaN(h)))) {
            var n = this.getDecimals(h);
            q < n && (q = n);
            g[j] = isNaN(g[j]) ? Math.abs(h) : g[j] + Math.abs(h);
            g[j] = AmCharts.roundTo(g[j],
                q);
            if ("regular" == b) {
    ...
    a = this.minMaxMultiplayer;
    this.min = this.getMin(this.start, this.end) * a;
    this.max = this.getMax() * a;
    a = this.guides.length;
    if (this.includeGuidesInMinMax && 0 < a)for (b = 0; b < a; b++)if (d = this.guides[b], d.toValue < this.min &&
        (this.min = d.toValue), d.value < this.min && (this.min = d.value), d.toValue > this.max && (this.max = d.toValue), d.value > this.max)this.max = d.value;
    ...
    var d = {type:"axisZoomed", startValue:a, endValue:b, target:this,
        chart:this.chart};
    this.fire(d.type, d)
    ...
    if (AmCharts.ifArray(a)) {
        ...
        if (this.parseDates && !this.equalSpacing) {
            if (this.timeDifference = this.endTime - this.startTime, d = this.choosePeriod(0), e = d.period, m = d.count, q = AmCharts.getPeriodDuration(e,
                ...
                p = l + 1.5 * q;
                p = AmCharts.resetDateToMin(new Date(p), e, m, r).getTime();
                k = (p - this.startTime) * this.stepWidth;
                o = !1;
                this.nextPeriod[a] &&
                (o = this.checkPeriodChange(this.nextPeriod[a], 1, p, l));
                var t = !1;
                o ? (l = this.dateFormatsObject[this.nextPeriod[a]], t = !0) : l = this.dateFormatsObject[a];
                s || (t = !1);
                l = AmCharts.formatDate(new Date(p), l);
                if (g == d && !i || g == h && !j)l = " ";
            ...
            if (this.parseDates && this.equalSpacing) {
                ...
                for (this.end - this.start > this.gridCount &&
                         (r = !0); g < n; g++)if (p = this.data[g].time, this.checkPeriodChange(e, m, p, l)) {
                    k = this.getCoordinate(g - this.start);
                    o = !1;
                    this.nextPeriod[a] && (o = this.checkPeriodChange(this.nextPeriod[a], 1, p, l));
                    t = !1;
                    o ? (l = this.dateFormatsObject[this.nextPeriod[a]], t = !0) : l = this.dateFormatsObject[a];
                    l = AmCharts.formatDate(new Date(p), l);
                    if (g == d && !i || g == h && !j)l = " ";
...
AmCharts.RecItem = AmCharts.Class({construct:function (a, b, d, e, f, g, h, i, j) {
    ...
    this.set = n;
    var p = a.axisThickness, o = a.axisColor, r = a.axisAlpha, s = a.tickLength, t = a.gridAlpha, w = a.gridThickness, y = a.gridColor, x = a.dashLength, u = a.fillColor, B = a.fillAlpha, I = a.labelsEnabled, D = a.labelRotation, U = a.counter, K = a.inside,
        M = a.dx, E = a.dy, R = a.orientation, L = a.position, P = a.previousCoord, da = a.viH, Y = a.viW, Z = a.offset, $, N;
    if (h) {
        if (I = !0, isNaN(h.tickLength) || (s = h.tickLength), void 0 != h.lineColor && (y = h.lineColor), isNaN(h.lineAlpha) || (t = h.lineAlpha), isNaN(h.dashLength) || (x = h.dashLength), isNaN(h.lineThickness) || (w = h.lineThickness), !0 == h.inside && (K = !0), !isNaN(h.labelRotation))D = h.labelRotation
    } else"" == d && (s = 0);
    N = "start";
    f && (N = "middle");
    var Q = D * Math.PI / 180, ga, C = 0, v = 0, ea = 0, ba = ga = 0;
    "V" == R && (D = 0);
    if (I)var S = AmCharts.text(q, d, m, k, l, N,
        i), ba = S.getBBox().width;
    if ("H" == R) {
        if (0 <= b && b <= Y + 1 && (0 < s && (0 < r && b + j <= Y + 1) && ($ = AmCharts.line(q, [b + j, b + j], [0, s], o, r, w), n.push($)), 0 < t))N = AmCharts.line(q, [b, b + M, b + M], [da, da + E, E], y, t, w, x), n.push(N);
        v = 0;
        C = b;
        h && 90 == D && (C -= l);
        ...
        "bottom" == L ? (v += da + l / 2 + Z, K ? 0 < D ? (v = da - ba / 2 * Math.sin(Q) - s - 3, C += ba / 2 * Math.cos(Q)) : v -= s + l + 3 + 3 : 0 < D ? (v = da + ba / 2 * Math.sin(Q) + s + 3, C -= ba / 2 * Math.cos(Q)) : v += s + p + 3 + 3) : (v += E + l / 2 - Z, C += M, K ? 0 < D ? (v = ba / 2 * Math.sin(Q) + s + 3, C -= ba / 2 * Math.cos(Q)) : v += s + 3 : 0 < D ? (v = -(ba / 2) * Math.sin(Q) - s - 6, C += ba / 2 * Math.cos(Q)) : v -= s + l + 3 + p + 3);
        "bottom" == L ? ga = (K ? da - s - 1 : da + p - 1) + Z : (ea = M, ga = (K ? E : E - s - p + 1) - Z);
        g && (C += g);
        E = C;
        0 < D && (E += ba / 2 * Math.cos(Q));
        if (S && (L = 0, K && (L = ba * Math.cos(Q)), E + L > Y + 1 || 0 > E))S.remove(), S = null
    } else {
        if (0 <= b && b <= da + 1 && (0 < s && (0 < r && b + j <=
            da + 1) && ($ = AmCharts.line(q, [0, s], [b + j, b + j], o, r, w), n.push($)), 0 < t))N = AmCharts.line(q, [0, M, Y + M], [b, b + E, b + E], y, t, w, x), n.push(N);
        N = "end";
        if (!0 == K && "left" == L || !1 == K && "right" == L)N = "start";
        v = b - l / 2;
        1 == U && (0 < B && !h) && (e = AmCharts.fitToBounds(b, 0, da), P = AmCharts.fitToBounds(P, 0, da), Q = e - P, fill = AmCharts.polygon(q, [0, a.width, a.width, 0], [0, 0, Q, Q], u, B), fill.translate(M, e - Q + E), n.push(fill));
        v += l / 2;
        "right" == L ? (C += M + Y + Z, v += E, K ? (C -= s + 4, g || (v -= l / 2 + 3)) : (C += s + 4 + p, v -= 2)) : K ? (C += s + 4 - Z, g || (v -= l / 2 + 3), h && (C += M, v += E)) : (C += -s - p - 4 -
            2 - Z, v -= 2);
        $ && ("right" == L ? (ea += M + Z + Y, ga += E, ea = K ? ea - p : ea + p) : (ea -= Z, K || (ea -= s + p)));
        g && (v += g);
        K = -3;
        "right" == L && (K += E);
        if (S && (v > da + 1 || v < K))S.remove(), S = null
    }
    $ && $.translate(ea, ga);
...
AmCharts.RadAxis = AmCharts.Class({construct:function (a) {
    ...
    if (b) {
        ...
        for (var a = b.chartData, q = a.length, n = 0; n < q; n++) {
            var p = 180 - 360 / q * n, o = g + this.axisWidth * Math.sin(p / 180 * Math.PI), r = h + this.axisWidth * Math.cos(p /
                180 * Math.PI), o = AmCharts.line(b.container, [g, o], [h, r], e, f, d);
            this.set.push(o);
            if (j) {
                var s = "start", o = g + (this.axisWidth + i) * Math.sin(p / 180 * Math.PI), r = h + (this.axisWidth + i) * Math.cos(p / 180 * Math.PI);
                if (180 == p || 0 == p)s = "middle", o -= 5;
                0 > p && (s = "end", o -= 10);
                180 == p && (r -= 5);
                0 == p && (r += 5);
                p = AmCharts.text(b.container, a[n].category, m, k, l, s);
                p.translate(o + 5, r);
                this.set.push(p);
                p.getBBox()
            }
...
AmCharts.RadItem = AmCharts.Class({construct:function (a, b, d, e, f, g, h) {
    ...
    this.set = e = l.set();
    var m = a.axisColor, q = a.axisAlpha, n = a.tickLength, p = a.gridAlpha, o = a.gridThickness, r = a.gridColor, s = a.dashLength, t = a.fillColor, w = a.fillAlpha, y = a.labelsEnabled, f = a.counter, x = a.inside, u = a.gridType, b = b - a.height, B, g = a.x, I = a.y;
    h ? (y = !0, isNaN(h.tickLength) || (n = h.tickLength),
        void 0 != h.lineColor && (r = h.lineColor), isNaN(h.lineAlpha) || (p = h.lineAlpha), isNaN(h.dashLength) || (s = h.dashLength), isNaN(h.lineThickness) || (o = h.lineThickness), !0 == h.inside && (x = !0)) : d || (p /= 3, n /= 2);
    var D = "end", U = -1;
    x && (D = "start", U = 1);
    if (y) {
        ...
        e.push(K);
        this.label = K;
        B = AmCharts.line(l, [g, g + n * U], [b, b], m, q, o);
        e.push(B)
    }
    b = a.y - b;
    if ("polygons" == u) {
        ...
        M.push(M[0]);
        E.push(E[0]);
        d = AmCharts.line(l, M, E, r, p, o, s)
    } else d = AmCharts.circle(l, b, "#FFFFFF", 0, o, r, p);
    d.translate(g, I);
    e.push(d);
    if (1 == f && 0 < w && !h) {
        h = a.previousCoord;
...
AmCharts.AmGraph = AmCharts.Class({construct:function () {
    ...
    N > ga && (N = ga);
    var C, v, ea, ba = j + 1, S = i + 1, Ja = 0, Ra = 0, Sa, Ta, Ka, La, yb = this.fillColors, Ca = this.negativeFillColors, ua = this.negativeLineColor, Da = this.fillAlphas, Ea = this.negativeFillAlphas;
    ...
    if (!U && ("line" == g || "smoothedLine" == g || "step" == g))if (1 == d.length && ("step" != g && "none" == this.bullet) && (this.bullet =
        "round", this.resetBullet = !0), Ca || void 0 != ua) {
        var va = E;
        va > f.max && (va = f.max);
        va < f.min && (va = f.min);
    ...
    if ("line" == g || "step" == g || "smoothedLine" == g) {
        if (0 < I)for (J = I - 1; -1 < J; J--)if (C = d[J], v = C.axes[f.id].graphs[a], ea = v.values.value) {
            I = J;
            break
        }
        if (D < d.length - 1)for (J = D + 1; J < d.length; J++)if (C = d[J], v = C.axes[f.id].graphs[a], ea = v.values.value) {
            D = J;
            break
        }
    }
    ...
    for (J = I; J <= D; J++) {
        ...
        v.index = J;
        var la = NaN,
            A = NaN, z = NaN, W = NaN, T = NaN, Na = NaN, wa = NaN, Oa = NaN, xa = NaN, V = NaN, aa = NaN, ma = NaN, na = NaN, O = NaN, ia = void 0, sa = yb, Fa = Da, ca = da;
        void 0 != v.color && (sa = v.color);
        v.fillColors && (sa = v.fillColors);
        isNaN(v.alpha) || (Fa = v.alpha);
        var oa = v.values;
        ...
        if (oa) {
            ...
            switch (g) {
                case "line":
                    if (isNaN(O))n || (this.drawLineGraph(p, o, ja, ka), p = [], o = [], ja = [], ka = []); else if (O < E && (v.isNegative = !0), p.push(A), o.push(z), V = A, aa = z, ma = A, na =
                        z, Ua)ja.push(W), ka.push(T);
                    break;
                case "smoothedLine":
                    if (isNaN(O))n || (this.drawSmoothedGraph(p, o, ja, ka), p = [], o = [], ja = [], ka = []); else if (O < E && (v.isNegative = !0), p.push(A), o.push(z), V = A, aa = z, ma = A, na = z, Ua)ja.push(W), ka.push(T);
                    break;
                case "step":
                    isNaN(O) ? n || (s = NaN, this.drawLineGraph(p, o, ja, ka), p = [], o = [], ja = [], ka = []) : (O < E && (v.isNegative = !0), l ? (isNaN(r) || (p.push(r), o.push(z - ya)), o.push(z - ya), p.push(A), o.push(z + Xa), p.push(A)) : (isNaN(s) || (o.push(s), p.push(A - ya)), p.push(A - ya), o.push(z), p.push(A + Xa), o.push(z)),
                        r = A, s = z, V = A, aa = z, ma = A, na = z);
                    break;
                case "column":
                    var za = ca;
                    void 0 != v.lineColor && (za = v.lineColor);
                    if (!isNaN(O)) {
                        O < E && (v.isNegative = !0, Ca && (sa = Ca), void 0 != ua && (ca = ua));
                        var lb = f.min, mb = f.max;
                        if (!(O < lb && (ha < lb || void 0 == ha) || O > mb && ha > mb))if (l) {
                            if ("3d" == u)var G = z - 0.5 * (h + N) + N / 2 + x * R, H = W + y * R; else G = z - (m / 2 - R) * (h + N) + N / 2, H = W;
                            var F = h, V = A, aa = G + h / 2, ma = A, na = G + h / 2;
                            G + F > j && (F = j - G);
                            0 > G && (F += G, G = 0);
                            var X = A - W, zb = H, H = AmCharts.fitToBounds(H, 0, i), X = X + (zb - H), X = AmCharts.fitToBounds(X, -H, i - H + y * R);
                            if (G < j && 0 < F && (ia = new AmCharts.Cuboid(e,
                                X, F, y, x, sa, Fa, L, za, P, $, q, l), "bottom" != B))if (B = "right", 0 > O)B = "left"; else if ("regular" == u || "100%" == u)V += this.dx
                        } else {
                            "3d" == u ? (H = A - 0.5 * (h + N) + N / 2 + y * R, G = T + x * R) : (H = A - (m / 2 - R) * (h + N) + N / 2, G = T);
                            F = h;
                            V = H + h / 2;
                            aa = z;
                            ma = H + h / 2;
                            ...
                            H + F > i + R * y && (F = i - H + R * y);
                            0 > H && (F += H, H = 0);
                            var X = z - T, Ab = G, G = AmCharts.fitToBounds(G, 0, j), X = X + (Ab - G), X = AmCharts.fitToBounds(X, -G + x * R, j - G);
                            if (H < i + R * y && 0 < F)if (ia = new AmCharts.Cuboid(e, F, X, y, x, sa, Fa, L, za, this.lineAlpha, $, q, l), 0 > O)B = "bottom"; else if ("regular" == u || "100%" == u)aa += this.dy
                        }
                        if (ia) {
                            var pa =
                                ia.set;
                            ...
                            if (!U) {
                                ...
                                "3d" == u && (l ? (w = (t - b) * (this.end + 1 - J), V += y * this.columnIndex, ma += y * this.columnIndex, v.y += y * this.columnIndex) : (w = (t - b) * (J + 1), V += 3, aa += x * this.columnIndex + 7, na += x * this.columnIndex, v.y += x * this.columnIndex));
                                ...
                                this.animateColumns(ia, J, A, W, z, T);
                ...
                case "candlestick":
                    if (!isNaN(ha) && !isNaN(Wa) && !isNaN(Va) && !isNaN(O)) {
                        var Pa, Ya;
                        O < ha && (v.isNegative = !0, Ca && (sa = Ca), Ea && (Fa = Ea), void 0 != ua && (ca = ua));
                        za = ca;
                        if (l) {
                            if (G = z - h / 2, H = W, F = h, G + F > j && (F = j - G), 0 > G && (F += G, G = 0), G < j && 0 < F) {
                                var Za, $a;
                                O > ha ? (Za = [A, Oa], $a = [W, Na]) : (Za = [W, Oa], $a = [A, Na]);
                                z < j && 0 < z && (Pa = AmCharts.line(e, Za, [z, z], ca, P, L), Ya = AmCharts.line(e, $a, [z, z], ca, P, L));
                                X = A - W;
                                ia = new AmCharts.Cuboid(e,
                                    X, F, y, x, sa, Da, L, za, P, $, q, l)
                            }
                        } else if (H = A - h / 2, G = T + L / 2, F = h, H + F > i && (F = i - H), 0 > H && (F += H, H = 0), X = z - T, H < i && 0 < F) {
                            var ia = new AmCharts.Cuboid(e, F, X, y, x, sa, Fa, L, za, P, $, q, l), ab, bb;
                            O > ha ? (ab = [z, xa], bb = [T, wa]) : (ab = [T, xa], bb = [z, wa]);
                            A < i && 0 < A && (Pa = AmCharts.line(e, [A, A], ab, ca, P, L), Ya = AmCharts.line(e, [A, A], bb, ca, P, L))
                        }
                        if (ia && (pa = ia.set, Z.push(pa), pa.translate(H, G), v.url && pa.setAttr("cursor", "pointer"), Pa && (Z.push(Pa), Z.push(Ya)), V = A, aa = z, ma = A, na = z, !U))v.x = l ? G + F / 2 : H + F / 2, this.animateColumns(ia, J, A, W, z, T), this.addListeners(pa,
                            v)
                    }
                    break;
                case "ohlc":
                    if (!isNaN(ha) && !isNaN(Wa) && !isNaN(Va) && !isNaN(O)) {
                        O < ha && (v.isNegative = !0, void 0 != ua && (ca = ua));
                        var cb, db, eb;
                        if (l) {
                            var fb = z - h / 2, fb = AmCharts.fitToBounds(fb, 0, j), nb = AmCharts.fitToBounds(z, 0, j), gb = z + h / 2, gb = AmCharts.fitToBounds(gb, 0, j);
                            db = AmCharts.line(e, [W, W], [fb, nb], ca, P, L, Y);
                            0 < z && z < j && (cb = AmCharts.line(e, [Na, Oa], [z, z], ca, P, L, Y));
                            eb = AmCharts.line(e, [A, A], [nb, gb], ca, P, L, Y)
                        } else {
                            var hb = A - h / 2, hb = AmCharts.fitToBounds(hb, 0, i), ob = AmCharts.fitToBounds(A, 0, i), ib = A + h / 2, ib = AmCharts.fitToBounds(ib,
                                0, i);
                            db = AmCharts.line(e, [hb, ob], [T, T], ca, P, L, Y);
                            0 < A && A < i && (cb = AmCharts.line(e, [A, A], [wa, xa], ca, P, L, Y));
                            eb = AmCharts.line(e, [ob, ib], [z, z], ca, P, L, Y)
                        }
                        Z.push(db);
                        Z.push(cb);
                        Z.push(eb);
            ...
            if (!U && !isNaN(O)) {
                ...
                if (this.end - this.start <= pb || 0 == pb) {
                    var Aa = this.createBullet(v, ma, na, J);
                    Aa || (Aa = 0);
                    var qb = this.labelText;
                    if (qb) {
                        var fa = this.createLabel(v, 0, 0, qb), ta = 0, Ba = 0, rb = fa.getBBox(), Qa = rb.width, jb = rb.height;
                        switch (B) {
                            case "left":
                                ta = -(Qa / 2 + Aa / 2 + 3);
                                break;
                            ...
                            case "right":
                                ...
                                break;
                            case "bottom":
                                l && "column" == g ? (V = M, 0 > O ? (ta = -6, fa.attr({"text-anchor":"end"})) : (ta = 6, fa.attr({"text-anchor":"start"}))) : (Ba = Aa / 2 + jb / 2, fa.x = -(Qa / 2 + 2));
                                break;
                            case "middle":
                                "column" == g && (l ? (ta = -(A - W) / 2 - y, 0 > X && (ta += y), Math.abs(A - W) < Qa && !this.showAllValueLabels && (fa.remove(), fa = null)) : (Ba = -(z - T) / 2, 0 > X && (Ba -= x), Math.abs(z - T) < jb && !this.showAllValueLabels && (fa.remove(), fa = null)))
                        }
                        if (fa)if (V += ta, aa += Ba, fa.translate(V, aa), l) {
                            if (0 > aa || aa > j)fa.remove(), fa =
                                null
                        } else {
                            var sb = 0;
                            "3d" == u && (sb = y * R);
                            if (0 > V || V > i + sb)fa.remove(), fa = null
                        }
                    }
    ...
    if ("line" == g || "step" == g || "smoothedLine" == g)"smoothedLine" == g ? this.drawSmoothedGraph(p, o, ja,
        ka) : this.drawLineGraph(p, o, ja, ka), U || this.launchAnimation()
    ...
    if (1 < a.length) {
        ...
        f.push(h);
        f.push(i);
        var j = this.lineAlpha, k = this.lineThickness, l = this.dashLength, f = this.fillAlphas, m = this.fillColors, q = this.negativeLineColor, n = this.negativeFillColors,
            p = this.negativeFillAlphas, o = this.baseCoord, r = AmCharts.line(g, a, b, this.lineColor, j, k, l, !1, !0);
        h.push(r);
        void 0 != q && (j = AmCharts.line(g, a, b, q, j, k, l, !1, !0), i.push(j));
        if (0 < f && (j = a.join(";").split(";"), k = b.join(";").split(";"), "serial" == this.chartType && (0 < d.length ? (d.reverse(), e.reverse(), j = a.concat(d), k = b.concat(e)) : this.rotate ? (k.push(k[k.length - 1]), j.push(o), k.push(k[0]), j.push(o), k.push(k[0]), j.push(j[0])) : (j.push(j[j.length - 1]), k.push(o), j.push(j[0]), k.push(o), j.push(a[0]), k.push(k[0]))), a = AmCharts.polygon(g,
            j, k, m, f, 0, 0, 0, this.gradientRotation), h.push(a), n || void 0 != q))p || (p = f), n || (n = q), g = AmCharts.polygon(g, j, k, n, p, 0, 0, 0, this.gradientRotation), i.push(g);
        this.applyMask(i, h)
    }
    ...
    if (1 < a.length) {
        ...
        f.push(h);
        f.push(i);
        var j = this.lineAlpha, k = this.lineThickness, f = this.dashLength,
            l = this.fillAlphas, m = this.fillColors, q = this.negativeLineColor, n = this.negativeFillColors, p = this.negativeFillAlphas, o = this.baseCoord, r = new AmCharts.Bezier(g, a, b, this.lineColor, j, k, m, 0, f);
        h.push(r.path);
        void 0 != q && (j = new AmCharts.Bezier(g, a, b, q, j, k, m, 0, f), i.push(j.path));
        if (0 < l && (k = a.join(";").split(";"), r = b.join(";").split(";"), j = "", 0 < d.length ? (d.reverse(), e.reverse(), k = a.concat(d), r = b.concat(e)) : (this.rotate ? (j += " L" + o + "," + b[b.length - 1], j += " L" + o + "," + b[0]) : (j += " L" + a[a.length - 1] + "," + o, j += " L" + a[0] +
            "," + o), j += " L" + a[0] + "," + b[0]), d = new AmCharts.Bezier(g, k, r, NaN, 0, 0, m, l, f, j), h.push(d.path), n || void 0 != q))p || (p = l), n || (n = q), a = new AmCharts.Bezier(g, a, b, NaN, 0, 0, n, p, f, j), i.push(a.path);
        this.applyMask(i, h)
    }
    ...
    if (0 < b && !a.animationPlayed) {
        ...
        }, 1E3 * a.index * b), a.timeOuts.push(b)) :
            a.animateGraphs()
    }
    ...
    if ("none" != this.bullet || a.bullet) {
        ...
        f = this.bullet;
        a.bullet && (f = a.bullet);
        var h = this.bulletBorderThickness, k = this.bulletBorderColor, l = this.bulletBorderAlpha, m = this.bulletAlpha,
            q = a.alpha;
        isNaN(q) || (m = q);
        switch (f) {
            case "round":
    ...
    if (i) {
        ...
        if ("serial" == this.chartType && (0 > b - f || b -
            f > this.width || d < -g / 2 || d - h > this.height))i.remove(), i = null;
    ...
    handleRollOver:function (a) {
        ...
        a &&
        (a = {type:"doubleClickGraphItem", item:a, index:a.index, graph:this, target:this, chart:this.chart}, this.fire("doubleClickGraphItem", a), this.chart.fire("doubleClickGraphItem", a))
    }, zoom:function (a, b) {
        this.start = a;
        this.end = b;
        this.draw()
...
AmCharts.ChartCursor = AmCharts.Class({construct:function () {
    ...
    var a = this.chart, b = this.cursorAlpha, d = a.categoryAxis, e =
        d.position, f = d.inside, g = d.axisThickness, h = this.categoryBalloon, i, j, k = a.dx, l = a.dy, m = this.x, q = this.y, n = this.width, p = this.height, a = a.rotate, o = d.tickLength;
    h.pointerWidth = o;
    a ? (i = [0, n, n + k], j = [0, 0, l]) : (i = [k, 0, 0], j = [l, 0, p - 1]);
    this.line = b = AmCharts.line(this.container, i, j, this.cursorColor, b, 1);
    this.set.push(b);
    a ? (f && (h.pointerWidth = 0), "right" == e ? f ? h.setBounds(m, q + l, m + n + k, q + p + l) : h.setBounds(m + n + k + g, q + l, m + n + 1E3, q + p + l) : f ? h.setBounds(m, q, n + m, p + q) : h.setBounds(-1E3, -1E3, m - o - g, q + p + 15)) : (h.maxWidth = n, d.parseDates &&
        (o = 0, h.pointerWidth = 0), "top" == e ? f ? h.setBounds(m + k, q + l, n + k + m, p + q) : h.setBounds(m + k, -1E3, n + k + m, q + l - o - g) : f ? h.setBounds(m, q, n + m, p + q - o) : h.setBounds(m, q + p + o + g - 1, m + n, q + p + o + g));
    this.hideCursor()
    ...
    zoom:function (a, b, d, e) {
        ...
        if (this.enabled) {
            void 0 == b && (b = !0);
            this.index = a;
            var g = d.categoryAxis, h = d.dx, i = d.dy, j = this.x, k = this.y, l = this.width, m = this.height, q = this.data[a], n = q.x[g.id], p = d.rotate, o = g.inside, r = this.stepWidth, s = this.categoryBalloon, t = this.firstTime, w = this.lastTime, y = this.cursorPosition, x = g.position, u = this.zooming, B = this.panning,
            ...
            if (d.mouseIsOver || u || B || this.forceShow)if (this.forceShow = !1, B) {
                ...
                0 != e && (k = {type:"zoomed", target:this}, k.chart = this.chart, g.parseDates && !g.equalSpacing ? (d + e > w && (e = w - d), u + e < t && (e = t - u), k.start = u + e, k.end = d + e, this.fire(k.type, k)) : h + e >= this.data.length || 0 > j + e || (k.start = j + e, k.end = h + e, this.fire(k.type, k)))
            } else {
                "start" ==
                    y && (n -= g.cellWidth / 2);
                "mouse" == y && d.mouseIsOver && (n = p ? f - 2 : e - 2);
                if (p) {
                ...
                0 < this.cursorAlpha && (t = this.line, p ? t.translate(0, n + i) : t.translate(n, 0), t.show());
                this.linePos = p ? n + i : n;
                u && (p ? this.updateSelectionSize(NaN, n) : this.updateSelectionSize(n, NaN));
                t = !0;
                u && (t = !1);
                this.categoryBalloonEnabled && t ? (p ? (o && ("right" == x ?
                    s.setBounds(j, k + i, j + l + h, k + n + i) : s.setBounds(j, k + i, j + l + h, k + n)), "right" == x ? o ? s.setPosition(j + l + h, k + n + i) : s.setPosition(j + l + h + D, k + n + i) : o ? s.setPosition(j, k + n) : s.setPosition(j - D, k + n)) : "top" == x ? o ? s.setPosition(j + n + h, k + i) : s.setPosition(j + n + h, k + i - D + 1) : o ? s.setPosition(j + n, k + m) : s.setPosition(j + n, k + m + D - 1), g.parseDates) ? (g = AmCharts.formatDate(q.category, this.categoryBalloonDateFormat), -1 != g.indexOf("fff") && (g = AmCharts.formatMilliseconds(g, q.category)), s.showBalloon(g)) : s.showBalloon(q.category) : s.hide();
                I && this.bulletsEnabled &&
                this.showBullets();
                this.destroyValueBalloons();
                if (I && this.valueBalloonsEnabled && t && d.balloon.enabled) {
                    this.valueBalloons = g = [];
                    if (this.oneBalloonOnly)for (var i = Infinity, U, t = 0; t < I.length; t++)r = I[t], r.showBalloon && (!r.hidden && r.balloonText) && (s = q.axes[r.valueAxis.id].graphs[r.id], w = s.y, isNaN(w) || (p ? Math.abs(e - w) < i && (i = Math.abs(e - w), U = r) : Math.abs(f - w) < i && (i = Math.abs(f - w), U = r)));
                    for (t = 0; t < I.length; t++)if (r = I[t], !(this.oneBalloonOnly && r != U) && (r.showBalloon && !r.hidden && r.balloonText) && (s = q.axes[r.valueAxis.id].graphs[r.id],
                        ...
                        if (p) {
                            if (i = w, 0 > n || n > m)o = !1
                        } else if (i = n, n = w, 0 > i || i > l + h)o = !1;
                        o && (o = r.valueBalloon, x = d.getBalloonColor(r, s), o.setBounds(j, k, j + l, k + m), o.pointerOrientation = "H", o.changeColor(x), void 0 != r.balloonAlpha && (o.fillAlpha = r.balloonAlpha), void 0 != r.balloonTextColor && (o.color = r.balloonTextColor), o.setPosition(i + j, n + k), r = d.formatString(r.balloonText, s, r), "" != r && o.showBalloon(r), !p && o.set && o.set.hide(), g.push({yy:w, balloon:o}))
                    }
                    p || this.arrangeBalloons()
                }
                b ? (k = {type:"changed"}, k.index = a,
                    k.target = this, k.chart = this.chart, k.zooming = u, k.position = p ? f : e, k.target = this, d.fire("changed", k), this.fire("changed", k), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, d.updateLegendValues(a));
            ...
            if (this.pan)this.rolledOver = !1; else if (this.zoomable && this.zooming) {
                ...
                if ("cursor" == this.type) {
                    if (this.rotate ? this.selectionPosY = d : this.selectionPosX = d = b, !(2 > Math.abs(d - this.initialMouse) && this.fromIndex == this.index))this.index < this.fromIndex ? (a.end = this.fromIndex, a.start = this.index) : (a.end = this.index, a.start = this.fromIndex), d = this.chart.categoryAxis, d.parseDates && !d.equalSpacing && (a.start = this.data[a.start].time,
                        a.end = this.data[a.end].time), this.skipZoomDispatch || this.fire(a.type, a)
                } else {
        ...
        var b = this.chart.categoryAxis, a = b.parseDates ? b.dateToCoordinate(a) :
            b.categoryToCoordinate(a);
        ...
        if (this.zoomable || this.pan || this.drawing) {
            ...
            if (0 < e && e < this.width && 0 < f && f < this.height || "fake" == a)this.setPosition(), this.drawing ? (this.drawStartY = f, this.drawStartX = e, this.drawingNow = !0) : this.pan ? (this.zoomable = !1, d.setMouseCursor("move"), this.panning = !0, this.panClickPos = b ? f : e, this.panClickStart = this.start, this.panClickEnd =
...
AmCharts.SimpleChartScrollbar = AmCharts.Class({construct:function () {
    ...
    d = i.x + f;
    e = i.y + g;
    var j = i.width, i = i.height, k = this.rotate, l = this.chart, m = this.width, q = this.height, n = l.mouseX, p = l.mouseY;
    a = this.initialMouse;
    l.mouseIsOver && (this.dragging && (l = this.initialCoord, k ? (a = l + (p - a), 0 > a && (a = 0), l = q - i, a > l && (a = l), h.setAttr("y", a)) : (a = l + (n - a), 0 > a && (a = 0), l = m - j, a > l && (a = l), h.setAttr("x", a))), this.resizingRight &&
...
AmCharts.ChartScrollbar = AmCharts.Class({inherits:AmCharts.SimpleChartScrollbar, construct:function () {
    ...
    if (k = a.graph) {
        ...
        for (var g = Infinity, h = -Infinity, n = 0; n < d.length; n++) {
            var p = d[n].axes[q.id].graphs[k.id].values, o;
            for (o in p)if ("percents" != o && "total" != o) {
                var r = p[o];
                r < g && (g = r);
                r > h && (h = r)
            }
        ...
        o.rotate = f;
        o.chart = b;
        o.chartType = b.chartType;
        o.data = d;
        o.valueAxis = m;
        o.chart = k.chart;
        o.categoryAxis = a.categoryAxis;
        o.valueField = k.valueField;
        o.openField = k.openField;
        o.closeField = k.closeField;
        o.highField = k.highField;
        o.lowField = k.lowField;
        o.lineAlpha = a.graphLineAlpha;
        o.lineColor = a.graphLineColor;
        o.fillAlphas = a.graphFillAlpha;
        o.fillColors = a.graphFillColor;
        o.connect = k.connect;
        o.hidden = k.hidden;
        o.width = i;
        o.height = j;
...
AmCharts.wedge = function (a, b, d, e, f, g, h, i, j, k, l) {
    ...
    -360 >= f && (f = -359.95);
    var p = 1 / 180 * Math.PI, o = b + Math.cos(e * p) * i, r = d + Math.sin(-e * p) * q, s = b + Math.cos(e * p) * g, t = d + Math.sin(-e * p) * h, w = b + Math.cos((e + f) * p) * g, y = d + Math.sin((-e - f) * p) * h, x = b + Math.cos((e + f) * p) * i, p = d + Math.sin((-e - f) * p) * q, u = {fill:AmCharts.adjustLuminosity(k.fill, -0.2), "stroke-opacity":0}, B = 0;
    180 < Math.abs(f) && (B = 1);
    var e = a.set(), I;
    n && (o = m(10 * o), s = m(10 * s), w = m(10 * w), x = m(10 * x), r = m(10 * r), t = m(10 *
        t), y = m(10 * y), p = m(10 * p), b = m(10 * b), j = m(10 * j), d = m(10 * d), g *= 10, h *= 10, i *= 10, q *= 10, 1 > Math.abs(f) && (1 >= Math.abs(w - s) && 1 >= Math.abs(y - t)) && (I = !0));
    if (0 < j) {
        var D;
        n ? (path = " M" + o + "," + (r + j) + " L" + s + "," + (t + j), I || (path += " A" + (b - g) + "," + (j + d - h) + "," + (b + g) + "," + (j + d + h) + "," + s + "," + (t + j) + "," + w + "," + (y + j)), path += " L" + x + "," + (p + j), 0 < i && (I || (path += " B" + (b - i) + "," + (j + d - q) + "," + (b + i) + "," + (j + d + q) + "," + x + "," + (j + p) + "," + o + "," + (j + r)))) : (path = " M" + o + "," + (r + j) + " L" + s + "," + (t + j), path += " A" + g + "," + h + ",0," + B + ",1," + w + "," + (y + j) + " L" + x + "," + (p + j),
            0 < i && (path += " A" + i + "," + q + ",0," + B + ",0," + o + "," + (r + j)));
        path += " Z";
        c = a.path(path, void 0, void 0, "1000,1000").attr(u);
        e.push(c);
        f = a.path(" M" + o + "," + r + " L" + o + "," + (r + j) + " L" + s + "," + (t + j) + " L" + s + "," + t + " L" + o + "," + r + " Z", void 0, void 0, "1000,1000").attr(u);
        j = a.path(" M" + w + "," + y + " L" + w + "," + (y + j) + " L" + x + "," + (p + j) + " L" + x + "," + p + " L" + w + "," + y + " Z", void 0, void 0, "1000,1000").attr(u);
        e.push(f);
        e.push(j)
    }
    n ? (I || (D = " A" + m(b - g) + "," + m(d - h) + "," + m(b + g) + "," + m(d + h) + "," + m(s) + "," + m(t) + "," + m(w) + "," + m(y)), g = " M" + m(o) + "," + m(r) + " L" +
        m(s) + "," + m(t) + D + " L" + m(x) + "," + m(p)) : g = " M" + o + "," + r + " L" + s + "," + t + (" A" + g + "," + h + ",0," + B + ",1," + w + "," + y) + " L" + x + "," + p;
    0 < i && (n ? I || (g += " B" + (b - i) + "," + (d - q) + "," + (b + i) + "," + (d + q) + "," + x + "," + p + "," + o + "," + r) : g += " A" + i + "," + q + ",0," + B + ",0," + o + "," + r);
...
AmCharts.AmPieChart = AmCharts.Class({inherits:AmCharts.AmChart, construct:function () {
    ...
    if (AmCharts.ifArray(b)) {
        if (0 < a.realWidth && 0 < a.realHeight) {
            ...
            if (!a.labelText || !a.labelsEnabled)p = o = 0;
            ...
            n || (f = 0 <= p ? f - i - j - 2 * o : f - i - j, g = g - k - l, n = Math.min(f, g), g < f && (n /= 1 - a.angle / 90, n > f && (n = f)), a.pullOutRadiusReal = AmCharts.toCoordinate(a.pullOutRadius, n), n = 0 <= p ? n - 1.8 * (p + a.pullOutRadiusReal) : n - 1.8 * a.pullOutRadiusReal, n /= 2);
            ...
            for (l = 0; l < b.length; l++)if (f = b[l], !0 != f.hidden && 0 < f.percents) {
                var r = 360 * -f.percents / 100, j = Math.cos((g + r / 2) / 180 * Math.PI), o = Math.sin((-g - r / 2) / 180 * Math.PI) * (k / n), i = {fill:f.color, stroke:a.outlineColor, "stroke-width":a.outlineThickness, "stroke-opacity":a.outlineAlpha};
                f.url && (i.cursor = "pointer");
                i = AmCharts.wedge(e, m, q, g, r, n, k, h, a.depth3D,
                    i, a.gradientRatio);
                ...
                if (a.labelsEnabled && a.labelText && f.percents >= a.hideLabelsPercent) {
                    r = g + r / 2;
                    0 >= r && (r += 360);
                    var j = m + j * (n + p), s = q + o * (n + p), t, o = 0;
                    if (0 <= p) {
                        var w;
                        90 >= r && 0 <= r ? (w = 0, t = "start", o = 8) : 360 >= r && 270 < r ? (w = 1, t = "start", o = 8) : 270 >= r && 180 < r ? (w = 2, t = "end", o = -8) : 180 >= r && 90 < r && (w = 3, t = "end", o = -8);
                        f.labelQuarter = w
                    } else t = "middle";
                    r = a.formatString(a.labelText,
                        f);
                    r = AmCharts.text(e, r, a.color, a.fontFamily, a.fontSize, t);
                    r.translate(j + 1.5 * o, s);
                    f.tx = j + 1.5 * o;
                    f.ty = s;
            ...
            a = this;
            a.chartCreated ?
                a.pullSlices(!0) : (s = setTimeout(function () {
                a.pullSlices.call(a)
    ...
    formatString:function (a, b) {
        ...
        for (var a = this.chartData, b = 0; b < a.length; b++)if (this.chartDataLabels[b]) {
            var d =
                a[b], e = d.ty, f = this.radiusReal, e = AmCharts.line(this.container, [this.pieXReal + d.ix * f, d.tx, d.tx2], [this.pieYReal + d.iy * f, e, e], this.labelTickColor, this.labelTickAlpha);
            d.wedge.push(e);
            this.ticks[b] = e
        }
        ...
        for (e = b - 1; 0 <= e; e--)d = a[e], 2 == d.labelQuarter && !d.hidden && this.checkOverlapping(e,
            d, 2, !0, 0);
        ...
        a.labelQuarter ==
            d && (!a.hidden && !b.hidden && g) && (f = f.getBBox(), d = {}, d.width = f.width, d.height = f.height, d.y = a.ty, d.x = a.tx, a = g.getBBox(), g = {}, g.width = a.width, g.height = a.height, g.y = b.ty, g.x = b.tx, AmCharts.hitTest(d, g) && (e = !0));
        return e
        ...
        for (var b =
            this.chartData, d = 0; d < b.length; d++) {
            var e = b[d];
        ...
        this.hideBalloon();
        a =
        {type:"rollOutSlice", dataItem:a, chart:this};
        this.fire(a.type, a)
        ...
        1 == b ? (a.pulled = !0, this.pullOutOnlyOne &&
            this.pullInAll(a.index), a = {type:"pullOutSlice", dataItem:a, chart:this}) : (a.pulled = !1, a = {type:"pullInSlice", dataItem:a, chart:this});
        this.fire(a.type, a)
        ...
        if (void 0 != b) {
            ...
            for (f = 0; f < a.length; f++)if (this.pieBaseColor ? h = AmCharts.adjustLuminosity(this.pieBaseColor, f * this.pieBrightnessStep / 100) : (h = this.colors[f], void 0 == h && (h = AmCharts.randomColor())), void 0 == a[f].color)a[f].color =
                h;
            this.recalculatePercents()
        }
...
AmCharts.AmXYChart = AmCharts.Class({inherits:AmCharts.AmRectangularChart, construct:function () {
    ...
    processValueAxis:function (a) {
        ...
        a && a.relativeZoom(this.widthMultiplyer,
            -this.horizontalPosition / this.widthMultiplyer);
        ...
        var b = this.fitMultiplyer(a.multiplyer),
            a = -a.position * b, d = -(this.plotAreaHeight * b - this.plotAreaHeight);
        a < d && (a = d);
        this.heightMultiplyer = b;
        this.verticalPosition = a;
        this.zoomChart()
    }, handleCursorZoom:function (a) {
        var b = this.widthMultiplyer * this.plotAreaWidth / a.selectionWidth, d = this.heightMultiplyer * this.plotAreaHeight / a.selectionHeight, b = this.fitMultiplyer(b), d = this.fitMultiplyer(d);
        ...
        if ("H" == a.valueAxis.orientation) {
            var b = this.fitMultiplyer(a.multiplyer), a = -a.position / this.widthMultiplyer * b, d = -(this.plotAreaWidth * b - this.plotAreaWidth);
            a < d && (a = d);
            this.horizontalPosition = a;
            this.widthMultiplyer = b
        } else b = this.fitMultiplyer(a.multiplyer), a = -a.position / this.heightMultiplyer * b, d = -(this.plotAreaHeight * b - this.plotAreaHeight), a < d && (a = d), this.verticalPosition = a, this.heightMultiplyer =
            b;
        this.zoomChart();
        this.zoomScrollbars()
    }, removeChartScrollbar:function () {
...
AmCharts.AmDraw = AmCharts.Class({construct:function (a, b, d) {
    ...
    g || (g = 0.3 * f);
    h < Math.abs(e) ?
        (h = e, a = g / 4) : a = g / (2 * Math.PI) * Math.asin(e / h);
    return h * Math.pow(2, -10 * b) * Math.sin((b * f - a) * 2 * Math.PI / g) + e + d
}, renderFix:function () {
    var a = this.container, b = a.style;
    b.left = "0px";
    b.top = "0px";
    a.getScreenCTM && a.createSVGMatrix && (a = a.createSVGMatrix() || a.getScreenCTM(), b.left = -(a.e - Math.floor(a.e)) + "px", b.top = -(a.f - Math.floor(a.f)) + "px")
}});
...
AmCharts.VMLRenderer = AmCharts.Class({construct:function (a) {
    ...
    if (void 0 !== d) {
        ...
        if ("shape" == g) {
            "cs" == b && (f.style.width =
                "100px", f.style.height = "100px", f.setAttribute("coordsize", d));
    ...
    getBox:function (a) {
        ...
        for (var b = a.split(" "), a = "", d, e = Math.round, f = 0; f < b.length; f++) {
            var g = b[f], h = g.substring(0, 1), g = g.substring(1), i = g.split(","), j = e(i[0]) +
                "," + e(i[1]);
            "M" == h && (a += " m " + j);
            "L" == h && (a += " l " + j);
            "Z" == h && (a += " x e");
        ...
        var g = this, h = a.node;
        if ("translate" == b) {
            var i = d.split(","), b = i[1], d = h.offsetTop, h = {obj:a, frame:0, attribute:"left", from:h.offsetLeft, to:i[0], time:e, effect:f};
            g.animations.push(h);
        ...
        for (var a = this.animations.length - 1; 0 <= a; a--) {
            ...
            if (e <= d) {
                ...
                0 == i ? this.animations.splice(a, 1) : f.node.style[g] =
                    b
        ...
        e.backgroundColor = f;
        e.paddingLeft = 1;
        var f = b * Math.PI / 180, g = Math.cos(f), h = Math.sin(f), i = AmCharts.removePx(e.left), j = AmCharts.removePx(e.top), k = d.offsetWidth, d = d.offsetHeight, l = b / Math.abs(b);
        e.left = i + k / 2 - k / 2 * Math.cos(f) - l * d / 2 * Math.sin(f) + 3;
        e.top = j - l * k / 2 * Math.sin(f) +
            l * d / 2 * Math.sin(f);
